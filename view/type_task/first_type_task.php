<h2>Задание <span class="task-number">1</span> / 2</h2>
<div>
    <h4>Сведения об организации</h4>
    <p>Ветеринарная клиника «Котопес». Находится в городе Краснодар по адресу ул. Калинина 157. Занимается лечением
        животных с применением современных медикаментозных препаратов и использованием современного оборудования для
        диагностики и лечения. Клиника работает в CRM системе Ветменеджер.
        В клинике «Котопес» недавно была запущена рекламная кампания. Чтобы отследить ее эффективность, клиника
        использует купон «Я профессионал», который даёт скидку 10% на все товары и услуги.
    </p>
    <h4>Ситуация</h4>
    <p>В клинику «Котопес» пришел на первичный прием
        ...
        Обращение в клинику было с жалобами на то, что у собаки повышена температура и она почти ничего не ест. Врач
        клиники провел осмотр и обнаружил, что повышение температуры и отсутствие аппетита было связано с гнойным
        воспалительным процессом - флегмона.
        <span class="changeable-text"><?= $this->arguments['animalName'] ?></span>
        ...
        заплатил за уколы 1100 руб. Укол жаропонижающий стоимостью 300 руб. и 2 укола с антибиотиком каждый по 400
        руб.
