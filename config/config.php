...
const PET_BREEDS_PATH = DATA_FOLDER_FOR_COLLECTION . DIRECTORY_SEPARATOR . 'breedsCat.json';
const TASK_TEMPLATE_DATA = DATA_FOLDER_FOR_COLLECTION . DIRECTORY_SEPARATOR . 'templateTask.json';
const IMG_FON_CERTIFICATE = PROJECT_DIR . DIRECTORY_SEPARATOR . "public" . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR . "certificate" . DIRECTORY_SEPARATOR . "fon.png";