...
const IMG_FON_CERTIFICATE = PROJECT_DIR . DIRECTORY_SEPARATOR . "public" . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR . "certificate" . DIRECTORY_SEPARATOR . "img.png";
const FONT_CERTIFICATE = PROJECT_DIR . DIRECTORY_SEPARATOR . "public" . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . "font" . DIRECTORY_SEPARATOR . "font-certificate.ttf";

const PDF = PROJECT_DIR . DIRECTORY_SEPARATOR . 'document.pdf';